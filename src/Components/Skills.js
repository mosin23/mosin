...
const Skills = () => {
  return (
    <div className='mt-10' id="skills">
        ...
        <h1 className='text-[40px] font-bold'>{AppText.Skills}<span className='text-[#136F63]'>{AppText.Experties}</span></h1>
        </div>
                    ...
                    {workDetail.map((item,index)=>(
                        <div className='flex flex-row mb-6'>
                            ...
                            <div>
                                ...
                                <h3 className='font-thin text-[15px] text-gray-400'>{item.marks}</h3>
